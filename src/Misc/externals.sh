...
if [[ "$PLATFORM" == "windows" ]]; then
    ...
    acquireExternalTool "$CONTAINER_URL/vstshost/m104_c2669e60/vstshost.zip" vstshost
    acquireExternalTool "$CONTAINER_URL/vstsom/m104_c2669e60_2/vstsom.zip" vstsom
