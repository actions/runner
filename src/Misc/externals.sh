...
if [[ "$PLATFORM" == "windows" ]]; then
    ...
    acquireExternalTool "$CONTAINER_URL/vstshost/m120_1_4186dcf3/vstshost.zip" vstshost
    acquireExternalTool "$CONTAINER_URL/vstsom/m120_1_4186dcf3/vstsom.zip" vstsom
