...
namespace GitHub.Runner.Common.Tests.Worker
{
    public sealed class ActionManagerL0
    {
        ...
        [Trait("Level", "L0")]
        [Trait("Category", "Worker")]
        public async Task GetDownloadInfoAsync_PropagatesActionsDependenciesLock_WhenPresent()
        {
            try
            {
                // Arrange
                ...
                _ec.Object.Global.ActionsDependenciesLock = dependencyLock;
                IList<string> dependencies = new List<string>
                {
                    "github.com/actions/checkout@v4:sha256-legacy"
                };
                _ec.Object.Global.ActionsDependencies = dependencies;
                ...
                Assert.Same(dependencies, capturedList.Dependencies);
                Assert.Same(dependencyLock, capturedList.LockfileDependencies);
            }
            finally
            {
                Teardown();
        ...
        [Trait("Level", "L0")]
        [Trait("Category", "Worker")]
        public async Task GetDownloadInfoAsync_DoesNotPropagateEmptyDependencyLists()
        {
            try
            {
                // Arrange
                ...
                Assert.Null(capturedList.LockfileDependencies);
            }
            finally
            {
                Teardown();
