...
namespace Microsoft.VisualStudio.Services.Agent.Tests.Worker.CodeCoverage
{
    public class CodeCoverageEnablerForJacocoGradleTests : IDisposable
    {
        ...
        {
            SetupMocks();
            LoadBuildFile(CodeCoverageConstants.BuildWithCCJacocoGradle);
            var enableCodeCoverage = new CodeCoverageEnablerForJacocoGradle();
            enableCodeCoverage.Initialize(_hc);
            enableCodeCoverage.EnableCodeCoverage(_ec.Object, new CodeCoverageEnablerInputs(_sampleBuildFilePath, _classDirectories, _include, _exclude, null, _summaryFile, _reportDirectory, null, null, false));
            VerifyJacocoCoverageForGradle(true);
        ...
        public void Gradle_EnableCodeCoverageWithNoSummaryFile()
        {
            ...
            var enableCodeCoverage = new CodeCoverageEnablerForJacocoGradle();
            enableCodeCoverage.Initialize(_hc);
            Assert.Throws<ArgumentException>(() => enableCodeCoverage.EnableCodeCoverage(_ec.Object, new CodeCoverageEnablerInputs(_sampleBuildFilePath, _classDirectories, _include, _exclude, null, null, _reportDirectory, null, null, false)));
        }
