...
namespace Microsoft.TeamFoundation.DistributedTask.ObjectTemplating
{
    ...
    {
        internal const String AllowExpressionsInSubTree = "allow-expressions-in-sub-tree";
        ...
        internal const String EachDirective = "each";
        ...
        internal const String IfDirective = "if";
        ...
        internal const String MappingConstant = "mapping-constant";
        ...
        internal const String NonEmptyScalar = "non-empty-scalar";
        internal const String OneOf = "one-of";
        internal const String OneOfConstant = "one-of-constant";
        ...
        internal const String ScalarConstant = "scalar-constant";
        ...
        internal const String SequenceConstant = "sequence-constant";
        ...
        internal const String SequenceOfNonEmptyScalar = "sequence-of-non-empty-scalar";
