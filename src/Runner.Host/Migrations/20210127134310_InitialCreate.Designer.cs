...
namespace Runner.Host.Migrations
{
    ...
    [Migration("20210127134310_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Runner.Host.Models.Agent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Runner.Host.Models.Pool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Runner.Host.Models.Agent", b =>
                {
                    b.HasOne("Runner.Host.Models.Pool", "Pool")
                        .WithMany("Agents")
