...
namespace GitHub.Runner.Listener
{
    ...
    public class SelfUpdaterV2 : RunnerService, ISelfUpdaterV2
    {
        ...
        private string GenerateUpdateScript(bool restartInteractiveRunner, string targetVersion)
        {
            ...
            string templateName = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "update.cmd.template" : "update.sh.template";
            ...
            string scriptName = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "_update.cmd" : "_update.sh";
